  ...
  return (
    <>
      <div className="sidebar-distributor-wide">
        <div className="sidebar-distributor-wide-top">
          <h3 className="sidebar-distributor-wide-title">
            <svg
        ...
        <div className="sidebar-distributor-wide-bottom">
      ...
      >
        ...
        <div className="sidebar-distributor-fullscreen-bottom">
          <div className="sidebar-distributor-fullscreen-cart-profile-wrapper">
            <button
              className="sidebar-distributor-fullscreen-bottom-element"
              onClick={() => {
                router.push("/distributor/profile");
              }}
            >
